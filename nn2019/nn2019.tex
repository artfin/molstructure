...
\block[titleoffsety=2cm, bodyoffsety=2cm]{Ab initio PES and IDS computation}{
    \SIZEOFTEXT
...
\column{0.6}
\block[titleoffsety=46cm, bodyoffsety=48.5cm]{CO$_2-$CO$_2$ rototranslational CIA band}{
    \SIZEOFTEXT
    \begin{tikzfigure}
...
\block[titleoffsety=2.0cm, bodyoffsety=4.0cm]{CO$_2-$Ar rototranslational CIA band}{
    \SIZEOFTEXT
    \begin{tikzfigure}
...
\block[titleoffsety=1.5cm, bodyoffsety=3.0cm]{References}{
