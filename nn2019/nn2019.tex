...
\block[titleoffsety=1cm, bodyoffsety=2cm]{Spectral moments}{
    ...
    \begin{tikzfigure}
        ...
        \includegraphics[width=0.49\linewidth]{./pictures/CO2-AR-second-moment-legend-crop.pdf} \\ [1em]
...
\column{0.6}
\block[titleoffsety=44cm, bodyoffsety=45.3cm]{Collision-induced absorption of CO$_2-$Ar and CO$_2-$CO$_2$ in rototranslational band}{
    \SIZEOFTEXT
    ...
    \begin{tikzfigure}
        ...
        \includegraphics[width=0.49\linewidth]{./pictures/CO2-AR-241K-legend-crop.pdf} \\[1em]
...
1. T. Karman, I.E. Gordon, A. van der Avoird, \textit{et al}. (2019). \textit{Icarus}. \\
...
9. I. R. Dagg et al. (1986), \textit{Can. J. Phys.} 64 (11), 1475-1481. \\
