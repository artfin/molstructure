...
Обращение классической траектории является одним из способов проверки ее качества, поэтому рассмотрим для каждой из систем уравнений преобразование координат, эффективно приводящее к инверсии времени.
...
Для обращения классической траектории в канонических переменных следует обратить знаки всех импульсов:
\begin{gather}
    \lb \mf{q}, \mf{p}, \bUpsilon, \pe \rb \rightarrow \lb \mf{q}, -\mf{p}, \bUpsilon, -\pe \rb.
\end{gather}
...
Так как угловой момент $\mf{J}$ линейно связан с эйлеровыми импульсами согласно соотношению \eqref{polyatom-angular-momentum-euler-momenta}, то для обращения классической траектории в этих переменных следует обратить знаки как у обобщенных моментов, так и у углового момента
\begin{gather}
    \lb \mf{q}, \mf{p}, \mf{J} \rb \rightarrow \lb \mf{q}, -\mf{p}, -\mf{J} \rb.
\end{gather}
...
Исходя из того, что при обращении классической траектории, происходит инверсия вектора углового момента, несложно получить следующие преобразования сферических углов вектора углового момента
\begin{gather}
    \lb \mf{q}, \mf{p}, \alpha, \beta \rb \rightarrow \lb \mf{q}, -\mf{p}, \alpha - \pi, \pi - \beta \rb.
\end{gather}
