...
\block[titleoffsety=1cm, bodyoffsety=2cm]{Calculation of spectral moments}{
\SIZEOFTEXT
\SIZEOFFORMULAE{
...
For the analysis of collision-induced spectra and the comparison with theory, certain integrals of the spectra, the spectal moments, are used. The $n$-th spectral moment of the spectral function, $J(\nu)$, is defined by [8]: 
\vverh
\begin{gather}
...
\column{0.5}
\block[titleoffsety=44cm, bodyoffsety=45.5cm]{Spectral moments of CO$_2-$Ar CIA spectral profile}{
\SIZEOFTEXT
\SIZEOFFORMULAE{
...
\block[titleoffsety=1.4cm, bodyoffsety=2.8cm]{References}{
...
\hspace*{-5cm}
\begin{flushright}
		\textbf{Partial support from RFBR Grant ... is gratefully accepted.}
\end{flushright}
\end{spacing}
}
