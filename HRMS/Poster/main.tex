...
\begin{tikzfigure}
		...
		\begin{center}
				\vspace*{-21cm} Figure 1: A scheme illustrating main areas of work and their interrelations 
		\end{center}
\end{tikzfigure}
\vspace{21cm}
}}
...
\vspace*{-1cm}
\begin{tikzfigure}
		\includegraphics[height=0.25\linewidth, width=0.5\linewidth]{../pictures/spec_picture/spec_picture-crop.pdf}
		\begin{center}
				Figure 2. Experimental absorption spectra of CO$_2-$Ar 
		\end{center}
\end{tikzfigure}
}}
\column{0.5}
...
\begin{tikzfigure}
	...
	\begin{center}
		\vspace*{-0.5cm}
		Figure 5: Temperature dependence of zeroth spectral moment	
	\end{center}
\end{tikzfigure}
\begin{tikzfigure}
	\hspace*{0.7cm}
	...
	\begin{center}
		\vspace*{-0.5cm}
		Figure 6: Temperature dependence of second spectral moment
	\end{center}
\end{tikzfigure}
}}
