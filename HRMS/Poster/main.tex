...
\newcommand{\SIZEOFTEXTREFERENCES}{\footnotesize}
...
\vpravo The temperature dependencies of the zeroth and second spectral moments are given on the Fig. 2 and Fig. 3 correspondingly. Markers represent the spectral moments obtained by integration of experimental spectra by means of the following formulae:
\vverh
\begin{gather}
...
\block[titleoffsety=1.5cm, bodyoffsety=1.8cm]{References}{
